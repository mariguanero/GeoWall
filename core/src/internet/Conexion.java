...
public class Conexion extends Pantalla {
	...
	public Conexion(GeoWallPrin game, Usuario user) {
		super(game, user);
		guardarRegistros();
		leerRegistros();
	}
	...
	//guardarRegistros
	protected void guardarRegistros(){
		// TODO Auto-generated constructor stub
			...
			HttpRequest httpPost = new HttpRequest(HttpMethods.GET);
			          //http://89.131.83.130/config2.php?nick=adsfa1&puntuacion=500&email=email&password=pass
			String url="http://89.131.83.130/config2.php?nick="+user.getNick()+"&puntuacion=" +
					user.getPuntuacionmax()+"&email="+user.getEmail()+"&password="+user.getPassword();
